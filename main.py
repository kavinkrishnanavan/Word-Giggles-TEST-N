...
Also, included with the new word parameter, tell a word which when searched in giphy, will give gifs which is accurate to the word entered by the user. seperate this with a comma (,)
Output format:
